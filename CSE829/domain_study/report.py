...
@media (prefers-color-scheme: dark){
  :root:not([data-theme="light"]){
    color-scheme: dark;
    --ground:#0e1315; --surface:#151c1f; --surface-2:#1c2529; --sunk:#111719;
    --ink:#eaf1f2; --ink-2:#a3b1b6; --ink-3:#77868c;
    --rule:#263135; --rule-soft:#1d272a;
    --accent:#42b7c6; --accent-ink:#7ed3de; --accent-wash:#102e33;
